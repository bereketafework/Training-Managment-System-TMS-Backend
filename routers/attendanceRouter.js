...
const validateAttendance = require("../validation/attendanceValidation");
...
// create a new users also validate a users data and Check Token
router.post("/create", validateAttendance, verifyToken, async (req, res) => {
  const data = req.body;
...
router.post("/update/:id", verifyToken, async (req, res) => {
  ...
  try {
    ...
    const existingArray = await db
      .select()
      .from(Attendances)
      .where(eq(Attendances.id, UsersId));
